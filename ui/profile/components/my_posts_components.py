...
def create_post_details_dialog(
    ...
    c_primary = ft.Colors.GREY_300 if is_dark else ft.Colors.GREY_800
    c_secondary = ft.Colors.GREY_400 if is_dark else ft.Colors.GREY_700
    c_hint = ft.Colors.GREY_500 if is_dark else ft.Colors.GREY_600
    c_divider = ft.Colors.GREY_700 if is_dark else ft.Colors.GREY_200
    ...
    if img_src:
        ...
        visual = ft.Container(
            ...
            border_radius=12,
            content=ft.Icon(ft.Icons.PETS, size=64, color=ft.Colors.GREY_500 if is_dark else ft.Colors.GREY_400),
        )

    def detail_row(icon: str, label: str, value: str) -> ft.Control:
        return ft.Row(
            [
                ft.Icon(icon, size=18, color=c_hint),
                ft.Text(label, size=13, weight=ft.FontWeight.W_600, color=c_secondary),
                ft.Text(value, size=13, color=c_primary, expand=True),
            ],
            spacing=8,
        )
        ...
        content=ft.Container(
            content=ft.Column(
                [
                    ...
                    ft.Divider(height=16, color=c_divider),
                    ...
                    ft.Divider(height=8, color=c_divider),
                    ft.Row(
                        [
                            ft.Text(
...
def build_my_post_card(
    ...
    if img_src:
        ...
        thumbnail = ft.Container(
            ...
            border_radius=10,
            alignment=ft.alignment.center,
            content=ft.Icon(ft.Icons.PETS, size=32, color=ft.Colors.GREY_500 if is_dark else ft.Colors.GREY_400),
        )
    ...
    info_col = ft.Column(
        [
            ...
            ft.Row(
                [
                    ft.Icon(ft.Icons.LOCATION_ON, size=12, color=c_hint),
                    ft.Text(ort, size=11, color=c_secondary, max_lines=1, overflow=ft.TextOverflow.ELLIPSIS),
                    ft.Text("•", size=11, color=c_hint),
